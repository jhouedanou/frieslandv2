...
class PDVCreationPage extends StatefulWidget {
  const PDVCreationPage({super.key});

  @override
  State<PDVCreationPage> createState() => _PDVCreationPageState();
}

class _PDVCreationPageState extends State<PDVCreationPage> {
  ...
  Future<void> _createPDV() async {
    ...
    try {
      ...
      final pdv = PDVModel(
        ...
        canal: _selectedType == 'Supermarché' || _selectedType == 'Superette' ? 'Moderne' : 'Traditionnel',
        ...
        rayonGeofence: 100.0, // 100m selon demande utilisateur
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Le PDV sera créé avec un rayon de géofencing de 300m. Le géofencing ne sera utilisé que pour vérifier votre présence lors des visites.',
                        style: TextStyle(
                          fontSize: 12,
